...
public class JoinTests {
    ...
    * 2. 패치 조인 : Jpql 에서 성능 최적화를 위해 제공하는 기능으로 연관된 엔터티나 컬렉션을 한 번에 조회할 수 있다.
    *               지연로딩이 아닌 즉시 로딩을 수행하여 join fetch 명령어를 사용한다.
    *
    * */
    ...
    public void 외부조인을_이용한_조회_테스트(){
        ...
        // 연관관계가 맺어진 엔터티드에 대한 left or right outer 조인을 말한다.
    ...
    public void 세타조인을_이용한_조회_테스트(){
        //세타조인은 조인되는 모든 경우의 수를 다 반환하는 크로스 조인과 같다
        // 엔티티들에 대한 조인을 말함
